...
public class DeviceHandInfoDAO extends BaseDAO<DeviceHandInfo, String> {
	/**
	 * 按照省地区分组统计已注册人脸识别设备信息
	 * @param areaId
	 * @return
	 */
	public List<?> groupDeviceHandByProvinceArea(String areaId) {
		String sql = "select t.EXAM_PROVINCE id,t.EXAM_PROVINCE_NAME name,count(*) total "
				+ "from DEVICE_HAND_INFO t where t.EXAM_PROVINCE like ? group by t.EXAM_PROVINCE,t.EXAM_PROVINCE_NAME "
	 ...
	 * @return
	 */
	public List<?> groupDeviceHandByExamArea(String areaId) {
		String sql = "select t.EXAM_AREA id,t.EXAM_AREA_NAME name,count(*) total "
				+ "from DEVICE_HAND_INFO t where t.EXAM_PROVINCE = ? group by t.EXAM_AREA,t.EXAM_AREA_NAME "
	 ...
	 * @return
	 */
	public List<?> groupDeviceHandByExamPlace(String areaId) {
		String sql = "select t.EXAM_PLACE id,t.EXAM_PLACE_NAME name,count(*) total "
				+ "from DEVICE_HAND_INFO t where t.EXAM_AREA like ? group by t.EXAM_PLACE,t.EXAM_PLACE_NAME "
