...
public class SocketExaminee3 implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5404008893989824951L;
	private Long id;
	...
	/** default constructor */
	public SocketExaminee3() {
	}

	/** minimal constructor */
	public SocketExaminee3(Long id, String subject, String licence,
	...
	public SocketExaminee3(Long id, String subject, String licence,
			...
			String checkCause, Boolean checkResult) {
		super();
		this.id = id;
		this.subject = subject;
		this.licence = licence;
	...
	public String toString() {
		return "SocketExaminee3 [id=" + id + ", subject=" + subject
