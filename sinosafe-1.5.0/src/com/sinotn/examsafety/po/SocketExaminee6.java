...
public class SocketExaminee6 implements java.io.Serializable {
	// Fields

	/**
	 * 
	 */
	private static final long serialVersionUID = 2512933935703387800L;
	private Long id;
	...
	/** default constructor */
	public SocketExaminee6() {
	}

	/** minimal constructor */
	public SocketExaminee6(Long id, String subject, String licence,
	...
	public String toString() {
		return "SocketExaminee1 [id=" + id + ", subject=" + subject
