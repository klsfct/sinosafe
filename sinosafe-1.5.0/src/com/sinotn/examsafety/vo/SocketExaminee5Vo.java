...
public class SocketExaminee5Vo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5580523925403466542L;
	/**
	 * 
	 */
	private Long id;
	...
	/** default constructor */
	public SocketExaminee5Vo() {
	}

	/** minimal constructor */
	public SocketExaminee5Vo(Long id, String subject, String licence,
	...
	/** full constructor */
	public SocketExaminee5Vo(SocketExaminee5 socketExaminee) {
	...
	public String toString() {
		return "SocketExaminee5Vo [id=" + id + ", subject=" + subject
