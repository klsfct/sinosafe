...
public class SocketExaminee3Vo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1959677293559164172L;
	private Long id;
	...
	/** default constructor */
	public SocketExaminee3Vo() {
	}

	/** minimal constructor */
	public SocketExaminee3Vo(Long id, String subject, String licence,
	...
	/** full constructor */
	public SocketExaminee3Vo(SocketExaminee3 socketExaminee) {
	...
	public String toString() {
		return "SocketExaminee3Vo [id=" + id + ", subject=" + subject
