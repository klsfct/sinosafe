...
public class ResultExaminee3Vo {
	...
	/** default constructor */
	public ResultExaminee3Vo() {
	}

	/** minimal constructor */
	public ResultExaminee3Vo(String licence) {
		this.licence = licence;
	}

	/** full constructor */
	public ResultExaminee3Vo(ResultExaminee3 resultExaminee3) {
		this.licence = resultExaminee3.getLicence();
		this.subject = resultExaminee3.getSubject();
		this.imeiNo = resultExaminee3.getImeiNo();
		this.relativePath = resultExaminee3.getRelativePath();
		this.absolutePath = resultExaminee3.getAbsolutePath();
		this.createDate = resultExaminee3.getCreateDate();
		this.modifyDate = resultExaminee3.getModifyDate();
		this.photoResult = resultExaminee3.getPhotoResult();
		this.isPass = resultExaminee3.getIsPass();
		this.isVerify = resultExaminee3.getIsVerify();
		this.verifyDate = resultExaminee3.getVerifyDate();
		this.verifyResult = resultExaminee3.getVerifyResult();
		this.faceExamineeName = resultExaminee3.getFaceExamineeName();
		this.faceIndetityDate = resultExaminee3.getFaceIndetityDate();
		this.filename = resultExaminee3.getFilename();
		this.isProcess = resultExaminee3.getIsProcess();
		this.photoPrecision = resultExaminee3.getPhotoPrecision();
		this.examProvince = resultExaminee3.getExamProvince();
		this.examProvinceName = resultExaminee3.getExamProvinceName();
		this.examArea = resultExaminee3.getExamArea();
		this.examAreaName = resultExaminee3.getExamAreaName();
		this.examPlace = resultExaminee3.getExamPlace();
		this.examPlaceName = resultExaminee3.getExamPlaceName();
		this.examRoom = resultExaminee3.getExamRoom();
		this.seatNumber = resultExaminee3.getSeatNumber();
		this.examineeName = resultExaminee3.getExamineeName();
		this.identity = resultExaminee3.getIdentity();
		this.photoPath = resultExaminee3.getPhotoPath();
	}
