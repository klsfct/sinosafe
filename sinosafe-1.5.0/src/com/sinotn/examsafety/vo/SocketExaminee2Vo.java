...
public class SocketExaminee2Vo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2275612455263525739L;
	private Long id;
	...
	/** default constructor */
	public SocketExaminee2Vo() {
	}

	/** minimal constructor */
	public SocketExaminee2Vo(Long id, String subject, String licence,
	...
	/** full constructor */
	public SocketExaminee2Vo(SocketExaminee2 socketExaminee) {
	...
	public String toString() {
		return "SocketExaminee2Vo [id=" + id + ", subject=" + subject
