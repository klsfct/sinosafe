...
public class SocketExaminee1Vo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4018160987470020811L;
	private Long id;
	...
	/** default constructor */
	public SocketExaminee1Vo() {
	}

	/** minimal constructor */
	public SocketExaminee1Vo(Long id, String subject, String licence,
	...
	/** full constructor */
	public SocketExaminee1Vo(SocketExaminee1 socketExaminee) {
	...
	public String toString() {
		return "SocketExaminee1Vo [id=" + id + ", subject=" + subject
