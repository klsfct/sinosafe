...
public class SocketExaminee6Vo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4068660987470020866L;
	private Long id;
	...
	/** default constructor */
	public SocketExaminee6Vo() {
	}

	/** minimal constructor */
	public SocketExaminee6Vo(Long id, String subject, String licence,
	...
	/** full constructor */
	public SocketExaminee6Vo(SocketExaminee6 socketExaminee) {
		...
		this.isPass = socketExaminee.getIsPass();
	}
	...
	public String toString() {
		return "SocketExaminee6Vo [id=" + id + ", subject=" + subject
