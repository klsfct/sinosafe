...
public class SocketExaminee4Vo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7963314545824108335L;
	private Long id;
	...
	/** default constructor */
	public SocketExaminee4Vo() {
	}

	/** minimal constructor */
	public SocketExaminee4Vo(Long id, String subject, String licence,
	...
	/** full constructor */
	public SocketExaminee4Vo(SocketExaminee4 socketExaminee) {
	...
	public String toString() {
		return "SocketExaminee4Vo [id=" + id + ", subject=" + subject
