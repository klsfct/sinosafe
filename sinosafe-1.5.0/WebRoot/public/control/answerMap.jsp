...
<html style="height: 100%">
   ...
   <body style="height: 100%; margin: 0">
       ...
       <div class="center-title">
            ...
            <p><span class="label" onclick="refush()">答题总数：</span><span id="totle1"></span></p>
            <p><span class="label" >回收总数：</span><span id="totle2"></span></p>
            <p><span class="label" onclick="closeWin()">回收率：</span><span id="totle3"></span></p>
        </div> 
        		...
        		success : function(data) {
        			if (data != null) {
        				if (data.dataStatus == "1") {
        					...
        					//题卡数
        					$("#totle1").html(allData.d4+"张");
        					//回收数 及回收率
        					$("#totle2").html(allData.d3+"张");
                ...
                formatter: function (params) {
                    if(params.componentSubType=="effectScatter" || params.componentSubType=="scatter"){
                        return params.name + 
                                ...
                                ' </br>联系电话：' + params.data.linkPhone;
                             
                    }else{
                    	//柱状图显示全部信息
                    	if(isTop20 == true){ 
                    		return top20[params.dataIndex].name + 
			                        ' </br>答题卡数：' + top20[params.dataIndex].d4 + 
			                        ' </br>回收数：' + top20[params.dataIndex].d3 +
			                        ' </br>回收率：' + top20[params.dataIndex].d2 +
			                        ' </br>联系人：' + top20[params.dataIndex].linkName +
			                        ' </br>联系电话：' + top20[params.dataIndex].linkPhone;
   				    	}else{
   				    		return bottom20[params.dataIndex].name + 
			                        ' </br>答题卡数：' + bottom20[params.dataIndex].d4 + 
			                        ' </br>回收数：' + bottom20[params.dataIndex].d3 +
			                        ' </br>回收率：' + bottom20[params.dataIndex].d2 +
			                        ' </br>联系人：' + bottom20[params.dataIndex].linkName +
			                        ' </br>联系电话：' + bottom20[params.dataIndex].linkPhone;
   				    	}
                    ...
                    label: {
                        normal: {
                            formatter: function (params) {
                            	//柱状图显示总人数和参考率
                            	if(isTop20 == true){
                            		return params.value+"%【"+top20[params.dataIndex].d3 +"张】";
           				    	}else{
           				    		return params.value+"%【"+bottom20[params.dataIndex].d3 +"张】";
           				    	}
