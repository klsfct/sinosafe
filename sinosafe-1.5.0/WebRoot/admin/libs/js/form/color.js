...
if ($("#skin").attr("prePath") != null) {
    colorPrePath = $("#skin").attr("prePath")
}
jQuery.fn.extend({
    colorRender: function() {
        return this.each(function() {
            new jscolor.color($(this)[0])
        })
    }
});
var jscolor = {
    ...
    loadImage: function(a) {
        if (!jscolor.imgLoaded[a]) {
            ...
            jscolor.imgLoaded[a].src = colorPrePath + "libs/images/formEle/" + a
        }
    },
    ...
    color: function(A, d) {
        ...
        function i(D, K) {
            if (!jscolor.picker) {
                ...
                for (var G = 0,
                J = 4; G < jscolor.images.sld[1]; G += J) {
            ...
            switch (b) {
            case 0:
                var H = colorPrePath + "libs/images/formEle/hs.png";
                break;
            case 1:
                var H = +colorPrePath + "libs/images/formEle/hv.png";
                break
            }
            I.padM.style.background = "url(" + colorPrePath + "libs/images/formEle/cross.gif) no-repeat";
            I.sldM.style.background = "url(" + colorPrePath + "libs/images/formEle/arrow.gif) no-repeat";
            I.pad.style.background = "url('" + H + "') 0 0 no-repeat";
            q();
            z();
