(function(c) {
    c.fn.stepperComp = function(f) {
        ...
        return this.each(function() {
            ...
            }).bind("mouseup.stepper",
            function(p) {
                i();
                c(this).removeClass(f.upClass).removeClass(f.downClass)
            }).bind("keydown.stepper",
            function(t) {
                if (!f.keys || c.grep(f.keys,
                function(u) {
