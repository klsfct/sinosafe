 ...
 * 更新高度
 */
window.jQuery.fn.autosizeUpdate = function() {
	var evt = document.createEvent('Event');
 ...
 * 取消自动
 */
window.jQuery.fn.autosizeDestroy = function() {
	var evt = document.createEvent('Event');
...
(function(e) {
    ...
    e.fn.perfectScrollbar = function(n, r) {
        return this.each(function() {
            ...
            t),
            a = e(this);
            if ("object" == typeof n ? e.extend(!0, l, n) : r = n, "update" === r) return a.data("perfect-scrollbar-update") && a.data("perfect-scrollbar-update")(),
            a;
            if ("destroy" === r) return a.data("perfect-scrollbar-destroy") && a.data("perfect-scrollbar-destroy")(),
            a;
            ...
            W = function() {
                ...
                e.left = D ? a.scrollLeft() + c - u: a.scrollLeft(),
                y ? e.bottom = L - a.scrollTop() : e.top = I + a.scrollTop(),
                g.css(e);
                var t = {
                    top: a.scrollTop(),
                    height: d,
            ...
            B = function() {
                ...
                o = function(o) {
                    ...
                    c = n[1];
                    e = !1,
                    l.useBothWheelAxes ? i && !s ? (c ? a.scrollTop(a.scrollTop() - c * l.wheelSpeed) : a.scrollTop(a.scrollTop() + r * l.wheelSpeed), e = !0) : s && !i && (r ? a.scrollLeft(a.scrollLeft() + r * l.wheelSpeed) : a.scrollLeft(a.scrollLeft() - c * l.wheelSpeed), e = !0) : (a.scrollTop(a.scrollTop() - c * l.wheelSpeed), a.scrollLeft(a.scrollLeft() + r * l.wheelSpeed)),
                    j(),
                    e = e || A(r, c),
            ...
            Q = function() {
                ...
                l = null,
                s = !1;
                e(window).bind("touchstart" + X,
                function() {
                    s = !0
                }),
                e(window).bind("touchend" + X,
                function() {
                    s = !1
                }),
                a.bind("touchstart" + X,
            ...
            F = function(t) {
                ...
                n = function() {
                    W = function() {
                        ...
                        y ? e.bottom = L: e.top = I,
                        w.css(e);
                        var t = {
                            top: b + a.scrollTop(),
                            height: h
                        };
                        C ? t.right = S: t.left = x,
                        T.css(t),
                        w.hide().show(),
                        T.hide().show()
                    }
            ...
            J = function() {
                ...
                a.data("perfect-scrollbar-update", j),
