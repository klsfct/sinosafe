(function($) {
    $.fn.imgZoomRender = function(options) {
        var zoomWidth = 200;
        var zoomHeight = 200;
        var zoomType = "standard";
        var hideEffect = "fadeout";
        var fadeoutSpeed = "slow";
        if ($(this).attr("zoomWidth") != null) {
            zoomWidth = parseInt($(this).attr("zoomWidth"))
        }
        if ($(this).attr("zoomHeight") != null) {
            zoomHeight = parseInt($(this).attr("zoomHeight"))
        }
        if ($(this).attr("zoomType") != null) {
            zoomType = $(this).attr("zoomType")
        }
        $(this).jqzoom({
            zoomWidth: zoomWidth,
