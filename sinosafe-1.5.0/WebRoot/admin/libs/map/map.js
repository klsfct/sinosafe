$(function(){
	...
	map.centerAndZoom("衡水市",12);  // 初始化地图,设置中心点坐标和地图级别
	map.setCurrentCity("衡水市");          // 设置地图显示的城市 此项是必须设置的
	...
	var url_list = "http://" + webUrl + "/sinosafe/baidu/getLinkManByLoginArea.action";  //服务端获取数据地址
