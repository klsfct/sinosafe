...
<body> 
	...
	<div class="top">
  	...
  	<div class="content" id="content">
		<!-- 左面start -->
		<div class="conRight conRightBorder" id="conRight">
			<div class="conRight-box-history">
			    <a class="searcBtn"></a>
				<input type="text" class="search"  id="inputSearch" placeholder="请输入关键字！">
				<div class="conRight-border">
					<div class="conRight-con">
						<div class="allNum">
							[ <span class="videoOnline"></span> / <span class="videoAll"></span>]
						</div>
...
var deviceIdArr=[];
//第一次请求树结构返回的数据
var url_tree_list = "../sh_deviceVideo/getDeviceVideoJsonByVideoType.action";
//搜索树结构最后一次输入名字
var lastValue = "";
//搜索树结构节点对象
var nodeList = [];
...
$(function(){
    ...
    $("#nowVideo").click(function(){
    	...
    	window.location.href="${basePath}/admin/video/gotoVideo.action?deviceVideoInfoVo.deviceType="+_deviceType;
    });
