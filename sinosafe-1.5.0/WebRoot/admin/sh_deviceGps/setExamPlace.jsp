...
<body>
	<div class="padding_top10 padding_bottom5 padding_left5 padding_right5">
		<s:form id="mainForm" method="post" action="setExamPlace" target="frmright"
			...
			<s:hidden name="deviceGpsInfoVo.entityName"></s:hidden>
				...
				<!-- <tr>
					<td colspan="2">
						<input id="ok" type="button" value=" 提 交 "  onclick="validateForm('#mainForm');"/>
					</td>
				</tr> -->
			</table>
		</s:form>
...
<script type="text/javascript">
	...
	function doVerify(){
	   ...
	   if(deviceType !=""){
	        $.ajax({
	            url:"${basePath}/admin/sh_deviceGps/verifyExamPlace.action",
