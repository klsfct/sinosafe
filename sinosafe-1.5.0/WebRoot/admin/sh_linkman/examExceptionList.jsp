...
<body>
	<div class="padding_top5 padding_right5 padding_bottom5">
		<div class="box_tool_user">
			<form id="queryForm" method="post">
				<ul>
					<li><span>上报类型 ：</span></li>
					<li><input type="text" name="query[0]_exceptionName_like" style="width:120px"/></li>
					<li>
	...
	<script type="text/javascript">
		...
		//列表url
		var url_data = name_space +"findExamExceptionList.action";
		//新建页面url
