...
<body>
	<div class="padding_top5 padding_right5 padding_bottom5">
		<div class="box_tool_user">
			<form id="queryForm" method="post">
				<ul>
					<li><span>分组名称：</span></li>
					<li><input type="text" name="query[0]_linkGroup.name_like" style="width:120px"/></li>
					<li>
					...
					<li><span>姓名：</span></li>
					<li><input type="text" name="query[0]_name_like" style="width:120px"/></li>
					<li>
						<div class="box_tool_line"></div>
					</li>
					<li><span>电话：</span></li>
					<li><input type="text" name="query[0]_phone_like" style="width:120px"/></li>
					<li>
						<div class="box_tool_line"></div>
					</li>
	...
	<script type="text/javascript">
		...
		//列表url
		var url_data = name_space +"findLinkManList.action";
		//新建页面url
		var url_addDialog = name_space +"gotoAddLinkMan.action";
		//修改页面url
		var url_editDialog = name_space + "gotoModifyLinkMan.action";
		//删除方法url
		var url_delete = name_space + "removeLinkMan.action";
		//重置密码
		var url_reply = name_space + "replyLinkManToPass.action";
		
		//拨打电话
		var url_phone = "../../public/gotoPhone.action";
		
		//ID变量名称
		var paramIdName = "linkManVo.id";
					...
					.quiGrid(
							{
								columns : [
										...
										},
										{
											...
											/* render : function(rowdata,
												...
												return " <a href=\"javascript:onPhone(\'"+ rowdata.name + "\',\'"+ value + "\')\" title='拨打电话' class='icon_phone hand'>"+value+"</a>";
											} */
										},
										{
											display : "创建人 ",
										...
										,
										 {
											...
											render : function(rowdata,
												...
												return " <a href=\"javascript:onEdit(\'"+ rowdata.id + "\')\" title='修改' class='icon_edit hand'>修改</a>"
														+ "<a href=\"javascript:onReply(\'"+ rowdata.id + "\')\" title='重置密码' class='icon_reply hand'>重置密码</a>"
								...
								pageSize:20,
							     toolbar:{
							    	 items:[
							    		  {text: "新建工作人员", click: addData,iconClass: "icon_add"},
							    		  { line : true }
							    		]
							     	}
							});
		...
		function onPhone(name,phone) {
			top.Dialog.open({
				URL : url_phone + "?linkManName=" + name+ "&linkManPhone=" + phone,
				Title : "拨打电话",
				Width : 600,
				Height : 300
			});
