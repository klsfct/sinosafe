...
<body>
	<div class="padding_top5 padding_right5">
		<form action="../sh_linkman/modifyLinkMan.action" id="mainForm"
			method="post">
			<input type="hidden" name="linkManVo.id" value="<s:property value='linkManVo.id'/>" />
			<table class="tableStyle" formMode="view">
				<tr>
					<td width="30%">分组名称 ：</td>
					<td><s:select list="linkGroupList" name="linkManVo.linkGroup.id"  cssStyle="font-size: 15px;"
									listKey="id" listValue="name"></s:select>
					</td>
				</tr>
				<tr>
					<td width="30%">选择考点 ：</td>
					<td><s:select list="examPlaceVoList" name="linkManVo.examPlaceVo.examPlace"  cssStyle="font-size: 15px;"
				...
				<tr>
					...
					<td><s:textfield name="linkManVo.phone"
							style="width: 250px;" cssClass="validate[custom[mobilephone],required,minSize[11]]" maxlength="11" 
