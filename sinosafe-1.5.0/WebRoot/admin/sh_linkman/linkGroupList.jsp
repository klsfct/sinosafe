...
<body>
	...
	<script type="text/javascript">
		...
		//列表url
		var url_data = name_space +"findLinkGroupList.action";
		//新建页面url
		var url_addDialog = name_space +"gotoAddLinkGroup.action";
		//修改页面url
		var url_editDialog = name_space + "gotoModifyLinkGroup.action";
		//删除方法url
