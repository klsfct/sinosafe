...
<body>
	<div class="padding_top5 padding_right5">
		<form action="../sh_linkman/modifyLinkGroup.action" id="mainForm"
			method="post">
			<input type="hidden" name="linkGroupVo.id" value="<s:property value='linkGroupVo.id'/>" />
			<table class="tableStyle" formMode="view">
				...
				<tr>
					<td width="30%">角色 ：</td>
					<td>	<s:select list="#{'1':'管理人员','2':'工作人员','3':'技术支持'}" name="linkGroupVo.roleCode" id="globlisSubject" cssStyle="font-size: 15px;"
