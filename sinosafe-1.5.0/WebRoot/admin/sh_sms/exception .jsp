...
<body>
		...
		<div class="box_tool_user">
			<form id="queryForm" method="post">
				<ul>
					...
					<li><input type="text" name="query_name_like" style="width:120px"/></li>
					<li>
	...
	<script type="text/javascript">
		...
		//列表url
		var url_data = name_space +"../json/personGroupList.json";// "findLinkGroupList.action";
		//新建页面url
		var url_addDialog = name_space +"linkGroupAdd.jsp";// "gotoAddLinkGroup.action";
		//修改页面url
		var url_editDialog = name_space + "linkGroupModify.jsp";//"gotoModifyLinkGroup.action";
		//删除方法url
		var url_delete= name_space + "removeLinkGroup.action";
		
		//ID变量名称
		var paramIdName = "linkGroupVo.id";
					...
					.quiGrid(
							{
								...
								pageSize:20,
							     toolbar:{
							    	 items:[
							    		  {text: "新建分组", click: addData,iconClass: "icon_add"},
							    		  { line : true }
							    		]
							     	}
							});
