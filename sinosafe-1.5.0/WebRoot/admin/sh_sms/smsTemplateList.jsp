					...
					.quiGrid(
							{
								columns : [
										...
										},
										{
											...
											render : function(rowdata,
												...
												return " <a href=\"javascript:onEdit(\'"+ rowdata.templateId + "\')\" title='修改' class='icon_edit hand'>修改</a>"
														+ "<a href=\"javascript:onDelete(\'"+ rowdata.templateId + "\')\" title='删除' class='icon_remove hand'>删除</a>";
											}
										} ],
								url : url_data,
								sortName : "id",
								...
								pageSize:20,
							     toolbar:{
							    	 items:[
							    		  {text: "新增模版", click: addData,iconClass: "icon_add"},
							    		  { line : true }
							    		]
							     	}
							});
