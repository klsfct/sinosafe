...
<body>
	<div class="padding_top5 padding_right5">
		<form action="../sh_sms/updateSmsTemplate.action" id="mainForm"
			method="post">
			<s:hidden name="smsTemplateVo.templateId"></s:hidden>
			<table class="tableStyle" formMode="view">
				...
				<tr>
					<td width="30%">模版内容 ：</td>
					<td><s:textfield name="smsTemplateVo.templateDescribe"
							style="width: 250px;"
