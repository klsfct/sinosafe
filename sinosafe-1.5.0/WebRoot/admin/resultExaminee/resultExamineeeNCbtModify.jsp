...
<body>
	<s:form id="paramFormId" name="paramForm" method="post"
		...
		<s:hidden name="roomCbtId"></s:hidden>
...
《<s:if test="resultExamineeVoList[0].subject==0">
		...
		<s:elseif test="subject==1">
			科目一
		</s:elseif>
		<s:elseif test="subject==2">
			科目二
		</s:elseif>
		<s:elseif test="subject==3">
			科目三
		</s:elseif>
			...
			<table class="tableStyle" mode="list">
				...
				<s:iterator value="resultExamineeVoList" status="st1">
					<tr>
						...
						<td class="ali02"><strong><s:property value="seatNumber" /></strong></td>
