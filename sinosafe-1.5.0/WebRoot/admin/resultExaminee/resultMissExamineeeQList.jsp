...
<body>
	...
	<script type="text/javascript">
		...
		function queryData() {
			...
			if(subject=="1"){
				$("#paramFormId").attr("action","findMissExaminee1QList.action");
			}
			else if(subject=="2"){
				$("#paramFormId").attr("action","findMissExaminee2QList.action");
			}
			else if(subject=="3"){
				$("#paramFormId").attr("action","findMissExaminee3QList.action");
			}
			else if(subject=="4"){
				$("#paramFormId").attr("action","findMissExaminee4QList.action");
			}
			else if(subject=="5"){
				$("#paramFormId").attr("action","findMissExaminee5QList.action");
			}
			else if(subject=="6"){
				$("#paramFormId").attr("action","findMissExaminee6QList.action");
			}
			$("#paramFormId").submit();
		}
		/* 2018.1.31 新增缺考人员导出 */
