...
<script src="../libs/js/bootstrap/jquery-1.7.2.min.js"></script>
...
<%-- <script type="text/javascript" src="./admin/libs/js/jquery.js"></script> --%>
  ...
  var exportAreaData_url = "${basePath}/areaDataExport.action";
  var exportPlaceData_url = "./facePlaceDataExport.action";
  var exportExaminee1Data_url = "${basePath}/examineeDataExport.action?subject=1";
  var exportExaminee2Data_url = "${basePath}/examineeDataExport.action?subject=2";
  var exportExaminee3Data_url = "${basePath}/examineeDataExport.action?subject=3";
  var exportExaminee4Data_url = "${basePath}/examineeDataExport.action?subject=4";
  var exportExaminee5Data_url = "${basePath}/examineeDataExport.action?subject=5";
  var exportExaminee6Data_url = "${basePath}/examineeDataExport.action?subject=6";
  
  
  var checkSubjectDataExport_url = "${basePath}/checkSubjectDataExport.action";
  var checkPlaceDataExport_url = "${basePath}/checkPlaceDataExport.action";
  var checkExamineeDataExport_url = "${basePath}/checkExamineeDataExport.action";
